...
export default function ProductGallery({ images }: ProductGalleryProps) {
  ...
  return (
    <div className="flex flex-col-reverse md:flex-row gap-4 w-full h-auto">
      ...
      <div className="relative flex-1 rounded-lg overflow-hidden flex items-center justify-center aspect-square border border-gray-100">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
        ...
        {/* Action Buttons (Bottom horizontally on mobile, Top-Right vertically on desktop) */}
        <div className="absolute bottom-4 right-4 md:top-4 md:bottom-auto flex flex-row md:flex-col gap-3">
