    ...
    <footer className="bg-brand-dark text-white mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <h3 className="font-bold text-lg mb-4 text-white">996+</h3>
            <ul className="space-y-2 text-sm text-zinc-300">
              <li>
                <Link
                  href="/plus"
        ...
        <div className="pt-8 border-t border-white-800 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-zinc-400">
